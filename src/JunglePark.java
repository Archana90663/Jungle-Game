...
public class JunglePark extends PApplet {
  ...
  public void setup() {
    ...
    AddAnimalButton AddTigerButton = new AddAnimalButton("tiger", 43, 16, this);
    AddAnimalButton AddDeerButton = new AddAnimalButton("deer", 129, 16, this);
    ClearButton clearButton = new ClearButton(215, 16, this);
    listGUI.add(clearButton);
    listGUI.add(AddDeerButton);
    listGUI.add(AddTigerButton);
